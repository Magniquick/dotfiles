...
Rectangle {
    ...
    readonly property bool tooltipActive: root.visible
        && root.hoveredTooltipTarget !== null
        && root.hoveredTooltipText !== ""
        && root.hoveredTooltipTarget.visible
    ...
    Item {
        ...
        Row {
            ...
            Row {
                ...
                Repeater {
                    ...
                    delegate: MK.Button {
                        ...
                        onHoveredChanged: root.syncTooltip(
                            modeButton,
                            modeButton.modelData.mode === "window" ? "Window" : (modeButton.modelData.mode === "screen" ? "Screen" : "Region"),
                            root.modeTooltipText(modeButton.modelData.mode),
                            hovered
                        )
                    }
                }
            ...
            Row {
                ...
                MK.Button {
                    ...
                    onHoveredChanged: root.syncTooltip(
                        freezeButton,
                        root.screenFrozen ? "Frozen Preview" : "Live Preview",
                        root.screenFrozen
                            ? "Use the frozen frame for precise picks."
                            : "Keep the preview live while choosing what to capture.",
                        hovered
                    )
                }
                ...
                MK.Button {
                    ...
                    onHoveredChanged: root.syncTooltip(
                        saveButton,
                        root.saveToDisk ? "Save to Disk" : "Copy Only",
                        root.saveToDisk
                            ? "Save screenshots to your screenshots directory."
                            : "Copy screenshots to the clipboard without keeping the file.",
                        hovered
                    )
                }
                ...
                Row {
                    ...
                    Item {
                        ...
                        MK.Button {
                            ...
                            onHoveredChanged: root.syncTooltip(
                                audioButton,
                                "Audio Mix",
                                `Cycle recording audio source. Current: ${root.currentAudioModeLabel()}.`,
                                hovered
                            )
                        }
                    }
                    ...
                    MK.Button {
                        ...
                        onHoveredChanged: root.syncTooltip(
                            recordButton,
                            root.preRecordMode ? "Cancel Recording" : "Start Recording",
                            root.recordTooltipText(),
                            hovered
                        )
                    }
                }
        ...
        Item {
            ...
            readonly property point anchorPoint: root.hoveredTooltipTarget
                ? root.mapFromItem(root.hoveredTooltipTarget, root.hoveredTooltipTarget.width / 2, 0)
            ...
            Rectangle {
                ...
                readonly property real baseX: Math.max(
                    0,
                    Math.min(
                        tooltipLayer.width - bubbleWidth,
                        tooltipLayer.anchorPoint.x - (bubbleWidth / 2)
                    )
                )
