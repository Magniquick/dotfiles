...
QtObject {
  ...
  property int idleMonitorSleepTimeoutSec: 10
  ...
  property bool idleIgnoreLidEvents: false
  ...
  function setIdleIgnoreLidEvents(enabled) {
    idleIgnoreLidEvents = !!enabled
  }

  function toggleIdleIgnoreLidEvents() {
    setIdleIgnoreLidEvents(!idleIgnoreLidEvents)
  }
