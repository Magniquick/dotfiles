...
Item {
  ...
  component GlowLayer : Rectangle {
    ...
    gradient: Gradient {
      ...
      GradientStop { position: 0.0; color: Common.Config.primary }
      GradientStop { position: 1.0; color: Common.Config.m3.info }
    }
  ...
  Item {
    ...
    GlowLayer { marginSize: 2; focusedOpacity: 0.3; unfocusedOpacity: 0.1 }
    GlowLayer { marginSize: 4; focusedOpacity: 0.15; unfocusedOpacity: 0 }
