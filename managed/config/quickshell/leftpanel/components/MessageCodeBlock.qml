  ...
  ColumnLayout {
    ...
    RowLayout {
      ...
      MK.ClickableSurface {
        ...
        radius: 10
        backgroundColor: copyBtn.copied ? Qt.alpha(Common.Config.color.tertiary, 0.15) : "transparent"
        hoverBackgroundColor: backgroundColor
        pressedBackgroundColor: backgroundColor
        rippleColor: Common.Config.color.on_surface
        rippleStateOpacity: copyBtn.hovered ? Common.Config.state.hoverOpacity : 0
        ...
        MouseArea {
          ...
          onWheel: wheel => {
            ...
            if (wheel.pixelDelta && wheel.pixelDelta.x !== 0) {
              ...
              deltaX = wheel.angleDelta.x / 2
            } else if (wheel.modifiers & Qt.ShiftModifier) {
              deltaX = wheel.angleDelta.y / 2
            }
