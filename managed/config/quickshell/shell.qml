...
ShellRoot {
  ...
  IpcHandler {
    ...
    function expandLatestTool(): bool {
      return leftPanel && leftPanel.setLatestVisibleToolExpanded ? leftPanel.setLatestVisibleToolExpanded(true) : false
    }

    function collapseLatestTool(): bool {
      return leftPanel && leftPanel.setLatestVisibleToolExpanded ? leftPanel.setLatestVisibleToolExpanded(false) : false
    }
  }
  IpcHandler {
    ...
    function debugHistory(): string {
      if (!Bar.GlobalState.hyprQuickshotController || typeof Bar.GlobalState.hyprQuickshotController.debugStateJson !== "function")
        return "[]"
      const state = JsonUtils.parseObject(Bar.GlobalState.hyprQuickshotController.debugStateJson()) || {}
  ...
  LazyLoader {
    ...
    active: Bar.GlobalState.hyprQuickshotVisible || Bar.GlobalState.screenRecordingActive || Bar.GlobalState.screenRecordingState !== "idle"
