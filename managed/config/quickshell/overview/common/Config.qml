        ...
        property QtObject appearance: QtObject {
            ...
            property QtObject font: QtObject {
                property QtObject family: QtObject {
                    property string main: root.readString("appearance.font.family.main", "Google Sans")
                    property string title: root.readString("appearance.font.family.title", "Google Sans")
                    property string expressive: root.readString("appearance.font.family.expressive", "Google Sans")
                }
