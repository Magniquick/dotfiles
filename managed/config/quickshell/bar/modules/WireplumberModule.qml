...
ModuleContainer {
  ...
  function isVirtualIoLabel(text) {
    ...
    const virtualKeywords = ["monitor", "loopback", "virtual", "null", "dummy", "audiorelay", "echo-cancel", "simultaneous"]
  ...
  Component {
    ...
    MK.ClickableSurface {
      ...
      hoverBackgroundColor: Qt.alpha(Config.color.surface_variant, 0.5)
      rippleColor: active ? Config.color.on_primary_container : Config.color.on_surface
  ...
  tooltipContent: Component {
    ColumnLayout {
      ...
      TooltipHeader {
        ...
        subtitle: root.volumeAvailable ? (root.muted ? "Muted" : (root.volumePercent + "%" + (root.volumePercent > 100 ? " • Boosted" : ""))) : "Unavailable"
        title: "Volume"
      }
        ...
        Item {
          ...
          ListView {
            ...
            delegate: MK.ClickableSurface {
              ...
              radius: Config.shape.corner.md
              backgroundColor: Config.color.surface_container_high
              hoverBackgroundColor: Qt.alpha(Config.color.surface_variant, 0.55)
