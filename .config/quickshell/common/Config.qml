...
QtObject {
  ...
  readonly property bool clipboardPopupEnabled: true
  readonly property string clipboardPopupLeftIcon: "󰒖"
  ...
  function fontVariableAxes(pixelSize, weight) {
    ...
    const cssWeight = qWeight > 100 ? qWeight : qWeight >= 75 ? 700 : qWeight >= 63 ? 600 : qWeight >= 57 ? 500 : 400
